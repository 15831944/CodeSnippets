...
namespace CADBest.GeometryNamespace
{
    ...
    public class Point3D
    {
        ...
        /// <summary>
        /// Convert CadBest Point3D to Net Point. Round values. Warning no Z value. 
        /// </summary>
        /// <returns>Point .NET</returns>
        public Point ToPointNET()
        {
            return new Point((int)Math.Round(this.X), (int)Math.Round(this.Y));
        }

        /// <summary>
        ///  Convert CadBest Point3D to Net PointF.Warning direcly convert to float. No Z value.
        /// </summary>
        /// <returns>PointF .NET</returns>
        public PointF ToPointFNET()
        {
